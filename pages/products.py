...
st.markdown('<div class="section-title">Product & Country Analysis</div>', unsafe_allow_html=True)
...
with tab1:
    ...
    with col3:
        ...
        fig3.add_trace(go.Bar(
            ...
            y=top10['Quantity'], marker_color='#1B3A5C'))
        fig3.update_layout(
...
with tab2:
    ...
    with col7:
        ...
        fig6.add_trace(go.Bar(
            ...
            y=top10c['Orders'], marker_color='#1B3A5C'))
        fig6.update_layout(
            barmode='group', height=320,
            plot_bgcolor='white', paper_bgcolor='white',
